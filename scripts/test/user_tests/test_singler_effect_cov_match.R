# ======================================================================================
# Fichier : scripts/test/user_tests/tests_single_effect_log_cov_match.R
#
# Objet   : Test single effect cov_match with different options
#
# ======================================================================================
...
fit_erpm <- erpm(partition_mix ~ cov_match("bin_att"),
                 nodes = nodes_df,
                 estimate="MLE", 
                 control=ctrl_A) 
