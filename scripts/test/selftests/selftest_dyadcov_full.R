...
# Objet   : Self-test autonome pour l'effet ERPM/ERGM `dyadcov_full`
# Exécution: Rscript scripts/test/selftests/selftest_dyadcov_full.R
# ======================================================================================
...
#   rhs_list <- list(
#     R1 = "dyadcov_full('Z1')",
#     R2 = "dyadcov_full('Z1', size = 2)",
#     R3 = "dyadcov_full('Z2')",
#     R4 = "dyadcov_full('Z2', size = 3)"
#   )
